...
const app = () => {
    ...
    (() => {
        ...
        const perViewItemSize = items.length < 5 ? items.length : 5;
        ...
        resize();
        // on(window, 'resize', debounce(resize));
    ...
    //event02 swiper
    (() => {
        const mainStoryProgramCarousel = new Swiper('.main-event02__contents--3-carousel .swiper', {
            initialSlide: 1,
            slidesPerView: 'auto',
            centeredSlides: true,
        });
    ...
    (() => {
        ...
        buttons.forEach((button, index) => {
            ...
            on(button, 'click', (event) => {
                ...
                tab.style.backgroundImage = `url(/m/assets/images/img_stroy_tab_${index + 1}.jpg)`;
